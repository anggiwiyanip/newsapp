...
@section('content')
    ...
    <article class="blog-post mt-5">
        ...
        @if ($data->image)
            <img src="{{ url('storage/' . $data->image) }}" alt="photo" class="card-img-top rounded-2"
                style="object-fit: fit; height: auto; widht: auto; display:block; margin-left:auto; margin-right:auto;">
        @endif
        ...
        @foreach ($comments->take(1) as $comment)
            <div class="my-1">
                ...
                <blockquote class="blockquote mb-0">
                    ...
                    <p class="blockqoute-footer mb-2"></p>
                </blockquote>
            </div>
        @endforeach
        @if ($comments->count() > 1)
    ...
    <a href="{{ route('landing') }}" class="btn btn-success mb-3">Back</a>

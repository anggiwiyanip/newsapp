        ...
        <div class="carousel-inner">
            @foreach ($posts as $p)
                <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                    <img src="{{ asset('storage/' . $p->image) }}" class="d-block w-100 rounded-2 opacity-50"
                        style="object-fit: cover; height:400px;" alt="Slide Image">
                    <div class="carousel-caption d-none d-md-block">
                        <h3>{{ $p->title }}</h3>
                        <a href="{{ url('posts/$p->slug/show') }}" class="text-dark">
